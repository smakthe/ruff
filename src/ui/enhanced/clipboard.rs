...
impl ClipboardManager {
    ...
    pub fn new() -> Result<Self, ClipboardError> {
        let clipboard = Clipboard::new().map_err(|e| ClipboardError::AccessError(e.to_string()))?;
    ...
    pub fn copy_to_clipboard(&self, content: &str) -> Result<(), ClipboardError> {
        ...
        let clipboard = clipboard
            .as_mut()
            .ok_or_else(|| ClipboardError::AccessError("Clipboard is not available".to_string()))?;
    ...
    pub fn copy_multiple_code_blocks(
        &self,
        code_blocks: &[(String, Option<String>)],
        include_language_headers: bool,
    ) -> Result<(), ClipboardError> {
    ...
    fn test_copy_conversation() {
        ...
        let messages = vec![
            ...
            (
                "Assistant".to_string(),
                "Hi there!".to_string(),
                Some("12:00:01".to_string()),
            ),
            (
                "User".to_string(),
                "How are you?".to_string(),
                Some("12:00:02".to_string()),
            ),
        ];
