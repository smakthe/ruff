...
impl ThemeService {
    ...
    fn load_builtin_themes(&mut self) {
        // Rust theme (default)
        self.themes.insert("rust".to_string(), Self::create_rust_theme());
        
        // Midnight theme (dark)
        self.themes.insert("midnight".to_string(), Self::create_midnight_theme());
        
        // Solar theme (light)
        self.themes.insert("solar".to_string(), Self::create_solar_theme());
        
        // High contrast themes
        self.themes.insert("high_contrast_light".to_string(), Self::create_high_contrast_light_theme());
        self.themes.insert("high_contrast_dark".to_string(), Self::create_high_contrast_dark_theme());
    }
...
mod tests {
    ...
    fn test_custom_theme_operations() {
        ...
        // Load custom themes
        let mut new_service = ThemeService::with_custom_themes_path(temp_dir.path());
