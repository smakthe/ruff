...
impl ModelRegistry {
    pub fn new() -> Self {
        ...
        // OpenAI Models
        models.insert("openai-gpt4".to_string(), AIModel {
            id: "gpt-4".to_string(),
        ...
        models.insert("openai-gpt3.5".to_string(), AIModel {
        ...
        // Anthropic Models
        models.insert("anthropic-claude3".to_string(), AIModel {
        ...
        // Cohere Models
        models.insert("cohere-command".to_string(), AIModel {
        ...
        // Together AI Models
        models.insert("together-llama2".to_string(), AIModel {
        ...
        models.insert("groq-llama3".to_string(), AIModel {
        ...
        models.insert("groq-mixtral".to_string(), AIModel {
        ...
        // Hugging Face Models
        models.insert("hf-mistral".to_string(), AIModel {
