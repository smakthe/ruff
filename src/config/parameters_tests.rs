...
mod tests {
    ...
    fn test_validate_parameters_valid() {
        ...
        assert!(manager
            ...
            .is_ok());
        assert!(manager
            .validate_parameters(0.0, 1, None, None, None)
            .is_ok());
        assert!(manager
            .validate_parameters(2.0, 32768, Some(1.0), Some(2.0), Some(2.0))
            .is_ok());
    }
    ...
    fn test_preset_characteristics() {
        ...
        for preset in analytical_presets {
            assert!(
                ...
                "Analytical preset '{}' should have low temperature",
                preset.name
            );
        }
        ...
        for preset in code_presets {
            assert!(
                ...
                "Code generation preset '{}' should have very low temperature",
                preset.name
            );
        }
    }
