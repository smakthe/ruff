...
mod tests {
    ...
    use crate::export::{BackupManager, ExportService, ImportService};
    ...
    async fn test_session_delete_command() -> Result<()> {
        ...
        let output =
            run_cli_command(&["session", "delete", &session_id.to_string(), "--force"]).await?;
    ...
    async fn test_session_archive_command() -> Result<()> {
        ...
        // Test archive
        let output = run_cli_command(&["session", "archive", &session_id.to_string()]).await?;
        ...
        // Test unarchive
        let output =
            run_cli_command(&["session", "archive", &session_id.to_string(), "--unarchive"])
                .await?;
    ...
    async fn test_session_search_command() -> Result<()> {
        ...
        let output = run_cli_command(&["session", "search", "Test", "--limit", "5"]).await?;
    ...
    async fn test_session_show_command() -> Result<()> {
        ...
        let output = run_cli_command(&["session", "show", &session_id.to_string()]).await?;
        ...
        // Test summary mode
        let output =
            run_cli_command(&["session", "show", &session_id.to_string(), "--summary"]).await?;
    ...
    async fn test_plugin_validate_command() -> Result<()> {
        ...
        fs::write(
            &plugin_path,
            serde_json::to_string_pretty(&plugin_metadata)?,
        )?;

        let output =
            run_cli_command(&["plugin", "validate", plugin_path.to_str().unwrap()]).await?;
    ...
    async fn test_config_show_command() -> Result<()> {
        ...
        let output =
            run_cli_command(&["config", "show", "--section", "ui", "--format", "json"]).await?;
        assert!(output.status.success());
    ...
    async fn test_config_init_command() -> Result<()> {
        ...
        let output = run_cli_command(&["config", "init", "--minimal", "--force"]).await?;
    ...
    async fn test_config_set_get_commands() -> Result<()> {
        // Test set command
        let output = run_cli_command(&["config", "set", "ui.theme", "dark"]).await?;
        ...
        // Test get command
        let output = run_cli_command(&["config", "get", "ui.theme"]).await?;
    ...
    async fn test_config_reset_command() -> Result<()> {
        let output = run_cli_command(&["config", "reset", "--section", "ui", "--force"]).await?;
    ...
    async fn test_invalid_session_id_handling() -> Result<()> {
        let output = run_cli_command(&["session", "delete", "invalid-uuid", "--force"]).await?;
    ...
    async fn test_nonexistent_session_handling() -> Result<()> {
        ...
        let output = run_cli_command(&["session", "show", &fake_uuid.to_string()]).await?;
    ...
    async fn test_plugin_nonexistent_handling() -> Result<()> {
        let output = run_cli_command(&["plugin", "info", "nonexistent-plugin"]).await?;
    ...
    async fn test_config_invalid_key_handling() -> Result<()> {
        let output = run_cli_command(&["config", "get", "invalid.nonexistent.key"]).await?;
